...
const sheetVariants = cva(
  'fixed z-50 gap-4 border border-border bg-card shadow-lg duration-200',
  {
    variants: {
      side: {
        right:
          'inset-y-0 right-0 flex h-full max-h-screen w-full flex-col overflow-hidden rounded-none border-l sm:w-[min(1200px,96vw)]',
